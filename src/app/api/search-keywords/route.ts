...
export async function POST(request: Request) {
  ...
  const prompt = `
    Generate a list of 10 longtail and semantic keywords related to "${keyword}".
    ...
    Format the response as a JSON array of objects, each containing the properties: keyword, difficulty, volume, and intent.
